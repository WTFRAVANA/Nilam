...
TELEGRAM_BOT_TOKEN = '7038722194:AAHpkrylC5BlbufwrEBNy8g826wLeFMsu-w'
ADMIN_USER_ID = 1200871394
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "*Let the war begin! 🌬️☢️*"
        "*BY Nirmal vala @wtf_ravana 🍷*"
    )
...
async def attack(update: Update, context: CallbackContext):
    ...
    await context.bot.send_message(chat_id=chat_id, text=(
        ...
        f"*🎖️ UNITED STATES OF KATHIYAWAD ⚔️*"
    ), parse_mode='Markdown')
